        ...
        public void Connect()
        {
            try
            {
               ...
               if (File.Exists(fIni) | rights.canWrite() & rights.canRead() )
             {
                 ...
                 proxyStream.Close();
                 /// reset file at Connect to avoid Whiny Furcadia
                }
                else /// Settings.ini update. 
                {
                 UseProxyIni = false;
                 Settings.InitializeFurcadiaSettings();

                 /// rember to reset settings on connect
                 /// 10 second delay on Use Proxy/Firewall reset for Furcadia News update
                }
            ...
            try
            {
                ...
                if (Connected != null)
                {
                    ...
                    else
                    {
                        ...
                        System.Timers.Timer NewsTimer = new System.Timers.Timer();
