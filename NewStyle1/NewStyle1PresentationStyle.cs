...
namespace NewStyle1
{
    ...
    /// of.</remarks>
    [PresentationStyleExport("NewStyle1", "NewStyle1", Version = AssemblyInfo.ProductVersion,
      Copyright = AssemblyInfo.Copyright, Description = "NewStyle1 custom presentation style")]
    public sealed class NewStyle1PresentationStyle : PresentationStyleSettings
    {
        /// <inheritdoc />
        ...
        /// Constructor
        /// </summary>
        public NewStyle1PresentationStyle()
        {
