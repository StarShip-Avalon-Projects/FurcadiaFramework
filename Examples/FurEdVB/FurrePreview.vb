...
#Region "Public Constructors"
    ...
    Public Sub New()
        ...
        AddSpecies(cr, "Rodent", 1, 1, 1, 1,
         2, 15, 20, 0)
        AddSpecies(cr, "Equine", 1, 21, 1, 1,
         2, 16, 21, 1)
        AddSpecies(cr, "Feline", 1, 41, 1, 1,
         2, 17, 22, 2)
        AddSpecies(cr, "Canine", 1, 61, 1, 1,
         2, 18, 23, 3)
        AddSpecies(cr, "Musteline", 1, 81, 1, 1,
         2, 19, 24, 4)
        AddSpecies(cr, "Lapine", 5, 0, 5, 5,
         5, 2, 1, 0)
        AddSpecies(cr, "Squirrel", 14, 0, 8, 8,
         8, 2, 1, 0)
        AddSpecies(cr, "Bovine", 15, 0, 10, 10,
         10, 2, 1, 0)
        AddSpecies(cr, "Ursine", 20, 0, 12, 12,
         12, 2, 1, 0)
        AddSpecies(cr, "Bugge", 33, 0, 25, 25,
         25, 2, 1, 0)

        cr = speciesChooser.Nodes.Add("Classic Wings")
        AddSpecies(cr, "Rodent", 2, 0, 1, 1,
         2, 15, 20, 0)
        AddSpecies(cr, "Equine", 2, 20, 1, 1,
         2, 16, 21, 1)
        AddSpecies(cr, "Feline", 2, 40, 1, 1,
         2, 17, 22, 2)
        AddSpecies(cr, "Canine", 2, 60, 1, 1,
         2, 18, 23, 3)
        AddSpecies(cr, "Musteline", 2, 80, 1, 1,
         2, 19, 24, 4)
        AddSpecies(cr, "Lapine", 6, 0, 5, 5,
         5, 2, 1, 0)
        AddSpecies(cr, "Squirrel", 14, 20, 8, 8,
         8, 2, 1, 0)
        AddSpecies(cr, "Bovine", 15, 20, 10, 10,
         10, 2, 1, 0)
        AddSpecies(cr, "Ursine", 20, 20, 12, 12,
         12, 2, 1, 0)

        cr = speciesChooser.Nodes.Add("Tri Wings")
        AddSpecies(cr, "Rodent", 7, 1, 1, 1,
         2, 15, 20, 0)
        AddSpecies(cr, "Equine", 7, 21, 1, 1,
         2, 16, 21, 1)
        AddSpecies(cr, "Feline", 7, 41, 1, 1,
         2, 17, 22, 2)
        AddSpecies(cr, "Canine", 7, 61, 1, 1,
         2, 18, 23, 3)
        AddSpecies(cr, "Musteline", 7, 81, 1, 1,
         2, 19, 24, 4)
        AddSpecies(cr, "Lapine", 8, 0, 5, 5,
         5, 2, 1, 0)
        AddSpecies(cr, "Squirrel", 14, 40, 8, 8,
         8, 2, 1, 0)
        AddSpecies(cr, "Bovine", 15, 40, 10, 10,
         10, 2, 1, 0)
        AddSpecies(cr, "Ursine", 20, 40, 12, 12,
         12, 2, 1, 0)

        cr = speciesChooser.Nodes.Add("Butterfly Wings")
        AddSpecies(cr, "Rodent", 9, 1, 1, 1,
         2, 15, 20, 0)
        AddSpecies(cr, "Equine", 9, 21, 1, 1,
         2, 16, 21, 1)
        AddSpecies(cr, "Feline", 9, 41, 1, 1,
         2, 17, 22, 2)
        AddSpecies(cr, "Canine", 9, 61, 1, 1,
         2, 18, 23, 3)
        AddSpecies(cr, "Musteline", 9, 81, 1, 1,
         2, 19, 24, 4)
        AddSpecies(cr, "Lapine", 10, 0, 5, 5,
         5, 2, 1, 0)
        AddSpecies(cr, "Squirrel", 14, 60, 8, 8,
         8, 2, 1, 0)
        AddSpecies(cr, "Bovine", 15, 60, 10, 10,
         10, 2, 1, 0)
        AddSpecies(cr, "Ursine", 20, 60, 12, 12,
         12, 2, 1, 0)

        cr = speciesChooser.Nodes.Add("Bat Wings")
        AddSpecies(cr, "Rodent", 13, 0, 1, 1,
         2, 15, 20, 0)
        AddSpecies(cr, "Equine", 13, 20, 1, 1,
         2, 16, 21, 1)
        AddSpecies(cr, "Feline", 13, 40, 1, 1,
         2, 17, 22, 2)
        AddSpecies(cr, "Canine", 13, 60, 1, 1,
         2, 18, 23, 3)
        AddSpecies(cr, "Musteline", 13, 80, 1, 1,
         2, 19, 24, 4)
        AddSpecies(cr, "Lapine", 13, 100, 5, 5,
         5, 2, 1, 0)
        AddSpecies(cr, "Squirrel", 14, 80, 8, 8,
         8, 2, 1, 0)
        AddSpecies(cr, "Bovine", 15, 80, 10, 10,
         10, 2, 1, 0)
        AddSpecies(cr, "Ursine", 20, 80, 12, 12,
         12, 2, 1, 0)

        cr = speciesChooser.Nodes.Add("Prime Wings")
        AddSpecies(cr, "Rodent", 16, 0, 1, 1,
         2, 15, 20, 0)
        AddSpecies(cr, "Equine", 16, 20, 1, 1,
         2, 16, 21, 1)
        AddSpecies(cr, "Feline", 16, 40, 1, 1,
         2, 17, 22, 2)
        AddSpecies(cr, "Canine", 16, 60, 1, 1,
         2, 18, 23, 3)
        AddSpecies(cr, "Musteline", 16, 80, 1, 1,
         2, 19, 24, 4)
        AddSpecies(cr, "Lapine", 16, 100, 5, 5,
         5, 2, 1, 0)
        AddSpecies(cr, "Squirrel", 16, 120, 8, 8,
         8, 2, 1, 0)
        AddSpecies(cr, "Bovine", 16, 140, 10, 10,
         10, 2, 1, 0)
        AddSpecies(cr, "Ursine", 20, 100, 12, 12,
         12, 2, 1, 0)

        cr = speciesChooser.Nodes.Add("Mythicals")
        AddSpecies(cr, "Dragon", 3, 0, 3, 3,
         3, 2, 1, 0)
        AddSpecies(cr, "Phoenix", 4, 0, 4, 4,
         4, 2, 1, 0)
        AddSpecies(cr, "Gryffe", 11, 0, 6, 6,
         6, 2, 1, 0)
        AddSpecies(cr, "Eagle", 12, 0, 7, 7,
         7, 2, 1, 0)
        AddSpecies(cr, "Kitterwing", 18, 0, 9, 9,
         9, 2, 1, 0)
        AddSpecies(cr, "Mini Kitter", 17, 0, 9, 9,
         9, 2, 1, 0)
        AddSpecies(cr, "Unicorn", 28, 0, 21, 21,
         21, 2, 1, 0)
        AddSpecies(cr, "Kirin", 34, 0, 26, 26,
         26, 2, 1, 0)
        AddSpecies(cr, "Naga", 55, 0, 41, 41,
         41, 2, 1, 0)
        ...
        AddSpecies(cr, "Wolven", 19, 0, 11, 11,
         11, 2, 1, 0)
        AddSpecies(cr, "Tygard", 21, 0, 13, 13,
         13, 2, 1, 0)
        AddSpecies(cr, "Leonen", 22, 0, 14, 14,
         14, 2, 1, 0)
        AddSpecies(cr, "Foxen", 26, 0, 19, 19,
         19, 2, 1, 0)
        AddSpecies(cr, "Catten", 41, 0, 30, 30,
         30, 2, 1, 0)
        AddSpecies(cr, "Owlen", 42, 0, 31, 31,
         31, 2, 1, 0)
        AddSpecies(cr, "Panooki", 54, 0, 40, 40,
         40, 2, 1, 0)
        ...
        AddSpecies(cr, "Furling", 29, 0, 22, 22,
         22, 2, 1, 0)
        AddSpecies(cr, "Noble Canine", 36, 0, 27, 27,
         27, 2, 1, 0)
        AddSpecies(cr, "Noble Feline", 38, 0, 28, 28,
         28, 2, 1, 0)
        AddSpecies(cr, "Noble Equine", 45, 0, 34, 34,
         34, 2, 1, 0)
        AddSpecies(cr, "Noble Rodent", 50, 0, 38, 38,
         38, 2, 1, 0)
        AddDynamicSpecies(cr, "Noble Musteline", 4)
        AddDynamicSpecies(cr, "Noble Lapine", 14)
        AddSpecies(cr, "Noble Hyooman", 52, 0, 39, 39,
         39, 2, 1, 0)

        cr = speciesChooser.Nodes.Add("Female Avatars")
        AddSpecies(cr, "Furling", 30, 0, 22, 22,
         22, 2, 1, 0)
        AddSpecies(cr, "Noble Canine", 37, 0, 27, 27,
         27, 2, 1, 0)
        AddSpecies(cr, "Noble Feline", 39, 0, 28, 28,
         28, 2, 1, 0)
        AddSpecies(cr, "Noble Equine", 46, 0, 34, 34,
         34, 2, 1, 0)
        AddSpecies(cr, "Noble Rodent", 51, 0, 38, 38,
         38, 2, 1, 0)
        AddDynamicSpecies(cr, "Noble Musteline", 5)
        AddDynamicSpecies(cr, "Noble Lapine", 15)
        AddSpecies(cr, "Noble Hyooman", 53, 0, 39, 39,
         39, 2, 1, 0)

        cr = speciesChooser.Nodes.Add("Seasonals")
        AddSpecies(cr, "Kiwi", 2, 100, 18, 18,
         18, 2, 1, 0)
        AddSpecies(cr, "Werewolf", 23, 0, 15, 15,
         15, 2, 1, 0)
        AddSpecies(cr, "Penguin", 24, 0, 16, 16,
         16, 2, 1, 0)
        AddSpecies(cr, "Bat", 25, 0, 17, 17,
         17, 2, 1, 0)
        AddSpecies(cr, "Flox", 27, 0, 20, 20,
         20, 2, 1, 0)
        AddSpecies(cr, "Chinchilla", 31, 0, 23, 23,
         23, 2, 1, 0)
        AddSpecies(cr, "Toasterwing", 32, 0, 24, 24,
         24, 2, 1, 0)
        AddSpecies(cr, "Reindeer", 40, 0, 29, 29,
         29, 2, 1, 0)
        AddSpecies(cr, "Lovebird", 43, 0, 32, 32,
         32, 2, 1, 0)
        AddSpecies(cr, "Woolie", 47, 0, 35, 35,
         35, 2, 1, 0)
        AddSpecies(cr, "Toytle", 48, 0, 36, 36,
         36, 2, 1, 0)
        AddSpecies(cr, "Tusker", 49, 0, 37, 37,
         37, 2, 1, 0)
...
#Region "Private Methods"
    ...
    Private Sub AddDynamicSpecies(parent As TreeNode, name As String, number As Integer)
        AddSpecies(parent, name, 100 + number, 0, 100 + number, 100 + number,
         100 + number, 2, 1, 0)
    End Sub
    ...
    '2, 15, 20, 0)
    Private Sub AddSpecies(parent As TreeNode, name As String, afile As Integer, aoffset As Integer, pmfile As Integer, pffile As Integer,
     pufile As Integer, pm As Integer, pf As Integer, pu As Integer)
        Dim newnode As New TreeNode(name)
        newnode.Tag = String.Format("{0},{1},{2},{3},{4},{5},{6},{7}", afile, aoffset, pmfile, pffile, pufile,
         pm, pf, pu)
