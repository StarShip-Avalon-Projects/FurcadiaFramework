...
#Region "Private Methods"
    ...
    Private Sub ChangeColourChoice(sender As Object, e As EventArgs) _
        Handles badgeListBox.SelectedIndexChanged, bootsListBox.SelectedIndexChanged, bracerListBox.SelectedIndexChanged,
        capeListBox.SelectedIndexChanged, eyeListBox.SelectedIndexChanged, furListBox.SelectedIndexChanged, hairListBox.SelectedIndexChanged,
    ...
    Private Sub RenderColourChoice(sender As Object, e As DrawItemEventArgs) _
        Handles badgeListBox.DrawItem, bootsListBox.DrawItem, bracerListBox.DrawItem,
        capeListBox.DrawItem, eyeListBox.DrawItem, furListBox.DrawItem, hairListBox.DrawItem,
        ...
        TextRenderer.DrawText(e.Graphics, DirectCast(giver.Items(e.Index), String), e.Font, TextArea, e.ForeColor, e.BackColor,
