...
<a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="T_Furcadia_Net_Utils_ServerParser_BaseServerInstruction">Furcadia.Net.Utils.ServerParser.BaseServerInstruction</a><br />&nbsp;&nbsp;&nbsp;&nbsp;<a href="T_Furcadia_Net_Utils_ServerParser_ChannelObject">Furcadia.Net.Utils.ServerParser.ChannelObject</a><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Furcadia.Net.Utils.ServerParser.DiceRolls<br />
...
**C++**<br />
``` C++
public ref class DiceRolls : public ChannelObject
```
...
type DiceRolls =  
    class
        inherit ChannelObject
    end
```

The DiceRolls type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Furcadia_Net_Utils_ServerParser_DiceRolls__ctor">DiceRolls</a></td><td>
Initializes a new instance of the DiceRolls class</td></tr></table>&nbsp;
<a href="#dicerolls-class">Back to Top</a>
