...
<a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="http://msdn2.microsoft.com/en-us/library/118wxtk3" target="_blank">System.EventArgs</a><br />&nbsp;&nbsp;&nbsp;&nbsp;Furcadia.Net.NetServerEventArgs<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="T_Furcadia_Net_NetChannelEventArgs">Furcadia.Net.NetChannelEventArgs</a><br />
...
``` C++
[SerializableAttribute]
public ref class NetServerEventArgs : public EventArgs
```

**F#**<br />
``` F#
[<SerializableAttribute>]
type NetServerEventArgs =  
    class
        inherit EventArgs
    end
```

The NetServerEventArgs type exposes the following members.
...
<a href="#netservereventargs-class">Back to Top</a>
