...
\[Missing <summary> documentation for "T:Furcadia.Net.Web.WebRequests"\]


## Inheritance Hierarchy
<a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;Furcadia.Net.Web.WebRequests<br />
...
**VB Usage**<br />
``` VB Usage
Dim instance As WebRequests
```

**C++**<br />
``` C++
public ref class WebRequests
```

**F#**<br />
``` F#
type WebRequests =  class end
```

The WebRequests type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Furcadia_Net_Web_WebRequests__ctor">WebRequests</a></td><td>
Initializes a new instance of the WebRequests class</td></tr></table>&nbsp;
<a href="#webrequests-class">Back to Top</a>
...
Creates a shallow copy of the current <a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">Object</a>.
 (Inherited from <a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">Object</a>.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")![Static member](media/static.gif "Static member")</td><td><a href="M_Furcadia_Net_Web_WebRequests_SendPostRequest">SendPostRequest</a></td><td>
Retriev Account information from the Furcadia Log-On server</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="http://msdn2.microsoft.com/en-us/library/7bxwbwt2" target="_blank">ToString</a></td><td>
