...
\[Missing <summary> documentation for "T:Furcadia.Net.Web.VariableIsConstantException"\]


## Inheritance Hierarchy
<a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="http://msdn2.microsoft.com/en-us/library/c18k6c59" target="_blank">System.Exception</a><br />&nbsp;&nbsp;&nbsp;&nbsp;Furcadia.Net.Web.VariableIsConstantException<br />
...
``` VB
<SerializableAttribute>
Public Class VariableIsConstantException
	Inherits Exception
```

**VB Usage**<br />
``` VB Usage
Dim instance As VariableIsConstantException
```

**C++**<br />
``` C++
[SerializableAttribute]
public ref class VariableIsConstantException : public Exception
```

**F#**<br />
``` F#
[<SerializableAttribute>]
type VariableIsConstantException =  
    class
        inherit Exception
    end
```
...
Initializes a new instance of the VariableIsConstantException class</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Furcadia_Net_Web_VariableIsConstantException__ctor_2">VariableIsConstantException(String)</a></td><td>
Initializes a new instance of the VariableIsConstantException class</td></tr><tr><td>![Protected method](media/protmethod.gif "Protected method")</td><td><a href="M_Furcadia_Net_Web_VariableIsConstantException__ctor_1">VariableIsConstantException(SerializationInfo, StreamingContext)</a></td><td>
Initializes a new instance of the VariableIsConstantException class</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Furcadia_Net_Web_VariableIsConstantException__ctor_3">VariableIsConstantException(String, Exception)</a></td><td>
Initializes a new instance of the VariableIsConstantException class</td></tr></table>&nbsp;
<a href="#variableisconstantexception-class">Back to Top</a>
