...
<a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;Furcadia.Net.Options.ServerOptions<br />
...
**VB Usage**<br />
``` VB Usage
Dim instance As ServerOptions
```

**C++**<br />
``` C++
public ref class ServerOptions
```
...
## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Furcadia_Net_Options_ServerOptions__ctor">ServerOptions</a></td><td>
Initializes a new instance of the ServerOptions class</td></tr></table>&nbsp;
<a href="#serveroptions-class">Back to Top</a>
