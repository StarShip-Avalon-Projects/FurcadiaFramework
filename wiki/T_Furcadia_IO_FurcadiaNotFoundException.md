...
<a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="http://msdn2.microsoft.com/en-us/library/c18k6c59" target="_blank">System.Exception</a><br />&nbsp;&nbsp;&nbsp;&nbsp;Furcadia.IO.FurcadiaNotFoundException<br />
...
**C#**<br />
``` C#
public class FurcadiaNotFoundException : Exception, 
	ISerializable
```

**VB**<br />
``` VB
Public Class FurcadiaNotFoundException
	Inherits Exception
...
**VB Usage**<br />
``` VB Usage
Dim instance As FurcadiaNotFoundException
```

**C++**<br />
``` C++
public ref class FurcadiaNotFoundException : public Exception, 
	ISerializable
```

**F#**<br />
``` F#
type FurcadiaNotFoundException =  
    class
        inherit Exception
...
The FurcadiaNotFoundException type exposes the following members.
...
Initializes a new instance of the FurcadiaNotFoundException class</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Furcadia_IO_FurcadiaNotFoundException__ctor_2">FurcadiaNotFoundException(String)</a></td><td>
Initializes a new instance of the FurcadiaNotFoundException class</td></tr><tr><td>![Protected method](media/protmethod.gif "Protected method")</td><td><a href="M_Furcadia_IO_FurcadiaNotFoundException__ctor_1">FurcadiaNotFoundException(SerializationInfo, StreamingContext)</a></td><td>
Initializes a new instance of the FurcadiaNotFoundException class</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Furcadia_IO_FurcadiaNotFoundException__ctor_3">FurcadiaNotFoundException(String, Exception)</a></td><td>
Initializes a new instance of the FurcadiaNotFoundException class</td></tr></table>&nbsp;
<a href="#furcadianotfoundexception-class">Back to Top</a>
