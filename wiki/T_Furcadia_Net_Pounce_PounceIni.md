...
\[Missing <summary> documentation for "T:Furcadia.Net.Pounce.PounceIni"\]


## Inheritance Hierarchy
<a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;Furcadia.Net.Pounce.PounceIni<br />
...
**VB Usage**<br />
``` VB Usage
Dim instance As PounceIni
```

**C++**<br />
``` C++
public ref class PounceIni
```

**F#**<br />
``` F#
type PounceIni =  class end
```

The PounceIni type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Furcadia_Net_Pounce_PounceIni__ctor">PounceIni</a></td><td>
Initializes a new instance of the PounceIni class</td></tr></table>&nbsp;
<a href="#pounceini-class">Back to Top</a>
