# FurcadiaPaletteException Class
This stuff is still in the planning stages. Any questions or Comments are welcome. _**\[This is preliminary documentation and is subject to change.\]**_

\[Missing <summary> documentation for "T:Furcadia.Drawing.Graphics.FurcadiaPaletteException"\]


## Inheritance Hierarchy
<a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="http://msdn2.microsoft.com/en-us/library/c18k6c59" target="_blank">System.Exception</a><br />&nbsp;&nbsp;&nbsp;&nbsp;<a href="http://msdn2.microsoft.com/en-us/library/ww58ded5" target="_blank">System.ApplicationException</a><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Furcadia.Drawing.Graphics.FurcadiaPaletteException<br />
...
**C#**<br />
``` C#
public class FurcadiaPaletteException : ApplicationException
```

**VB**<br />
``` VB
Public Class FurcadiaPaletteException
	Inherits ApplicationException
```

**VB Usage**<br />
``` VB Usage
Dim instance As FurcadiaPaletteException
```

**C++**<br />
``` C++
public ref class FurcadiaPaletteException : public ApplicationException
```

**F#**<br />
``` F#
type FurcadiaPaletteException =  
    class
        inherit ApplicationException
    end
```

The FurcadiaPaletteException type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Furcadia_Drawing_Graphics_FurcadiaPaletteException__ctor">FurcadiaPaletteException</a></td><td>
Initializes a new instance of the FurcadiaPaletteException class</td></tr></table>&nbsp;
<a href="#furcadiapaletteexception-class">Back to Top</a>
