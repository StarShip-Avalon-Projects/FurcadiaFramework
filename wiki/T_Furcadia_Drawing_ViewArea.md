...
<a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;Furcadia.Drawing.ViewArea<br />
...
**C++**<br />
``` C++
public ref class ViewArea
```

**F#**<br />
``` F#
type ViewArea =  class end
```

The ViewArea type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Furcadia_Drawing_ViewArea__ctor">ViewArea</a></td><td>
Initializes a new instance of the ViewArea class</td></tr></table>&nbsp;
<a href="#viewarea-class">Back to Top</a>
