...
<a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="http://msdn2.microsoft.com/en-us/library/c18k6c59" target="_blank">System.Exception</a><br />&nbsp;&nbsp;&nbsp;&nbsp;Furcadia.IO.FurcadiaIOException<br />
...
**C#**<br />
``` C#
public class FurcadiaIOException : Exception, 
	ISerializable
```

**VB**<br />
``` VB
Public Class FurcadiaIOException
	Inherits Exception
...
**VB Usage**<br />
``` VB Usage
Dim instance As FurcadiaIOException
```

**C++**<br />
``` C++
public ref class FurcadiaIOException : public Exception, 
	ISerializable
```

**F#**<br />
``` F#
type FurcadiaIOException =  
    class
        inherit Exception
...
The FurcadiaIOException type exposes the following members.
...
Initializes a new instance of the FurcadiaIOException class</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Furcadia_IO_FurcadiaIOException__ctor_2">FurcadiaIOException(String)</a></td><td>
Initializes a new instance of the FurcadiaIOException class</td></tr><tr><td>![Protected method](media/protmethod.gif "Protected method")</td><td><a href="M_Furcadia_IO_FurcadiaIOException__ctor_1">FurcadiaIOException(SerializationInfo, StreamingContext)</a></td><td>
Initializes a new instance of the FurcadiaIOException class</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Furcadia_IO_FurcadiaIOException__ctor_3">FurcadiaIOException(String, Exception)</a></td><td>
Initializes a new instance of the FurcadiaIOException class</td></tr></table>&nbsp;
<a href="#furcadiaioexception-class">Back to Top</a>
